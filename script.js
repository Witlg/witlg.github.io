(function() {
    ...
    // данные для проектов (можно редактировать)
    const projectData = {
        'проект 1': {
        ...
        'проект 5': {
            ...
            desc: 'Внутренняя система для управления задачами, документацией и коммуникацией в команде до 500+ человек.',
            date: '2024',
            tech: 'Angular · NestJS · MongoDB'
        },
        'проект 6': {
            title: 'Игровой проект',
            desc: '2D-платформер с физикой, уровнями и мультиплеером. Оптимизирован для мобильных устройств.',
            date: '2023',
            tech: 'Unity · C# · Photon'
        }
    };
