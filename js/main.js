...
/** Данные гаражей (с добавленным статусом) */
const garagesData = [
    {
        id: 1,
        name: 'Гараж №1',
...
const transportData = {
    cars: [
        { name: 'Toyota Camry', price: '3 200 000', year: '2020', engine: '2.5 л', image: 'https://images.unsplash.com/photo-1621007947382-bb3c3994e3fb?w=600&h=400&fit=crop' },
        { name: 'BMW X5', price: '6 500 000', year: '2021', engine: '3.0 л', image: 'https://images.unsplash.com/photo-1555215695-3004980ad54e?w=600&h=400&fit=crop' },
        { name: 'Mercedes-Benz E-Class', price: '4 800 000', year: '2019', engine: '2.0 л', image: 'https://images.unsplash.com/photo-1565022536102-f7645b12d9bf?w=600&h=400&fit=crop' },
        { name: 'Audi A6', price: '3 900 000', year: '2020', engine: '2.0 л', image: 'https://images.unsplash.com/photo-1606664515524-ed2f786a0bd6?w=600&h=400&fit=crop' }
    ],
    trucks: [
        { name: 'Volvo FH', price: '8 200 000', year: '2020', capacity: '20 т', image: 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?w=600&h=400&fit=crop' },
        { name: 'Scania R-Series', price: '7 500 000', year: '2019', capacity: '25 т', image: 'https://images.unsplash.com/photo-1566150905458-1bf1fc113f0d?w=600&h=400&fit=crop' },
        { name: 'MAN TGX', price: '6 800 000', year: '2020', capacity: '22 т', image: 'https://images.unsplash.com/photo-1601584115197-04ecc0da31d7?w=600&h=400&fit=crop' }
    ],
    motorcycles: [
        { name: 'Harley-Davidson Fat Boy', price: '2 100 000', year: '2021', engine: '1.8 л', image: 'https://images.unsplash.com/photo-1589684785780-a1f31046f8f0?w=600&h=400&fit=crop' },
        { name: 'Ducati Panigale V4', price: '2 800 000', year: '2020', engine: '1.1 л', image: 'https://images.unsplash.com/photo-1568772585407-9361f9bf3a87?w=600&h=400&fit=crop' },
        { name: 'Yamaha MT-09', price: '1 200 000', year: '2021', engine: '0.9 л', image: 'https://images.unsplash.com/photo-1591637333184-19aa0843b235?w=600&h=400&fit=crop' }
    ],
    water: [
        { name: 'Bayliner 285', price: '4 500 000', year: '2020', length: '8.5 м', image: 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=600&h=400&fit=crop' },
        { name: 'Sea Ray 260', price: '3 800 000', year: '2019', length: '7.9 м', image: 'https://images.unsplash.com/photo-1533130061792-64b345e4a833?w=600&h=400&fit=crop' },
        { name: 'Yamaha AR195', price: '2 900 000', year: '2021', length: '6.0 м', image: 'https://images.unsplash.com/photo-1567899378494-47b22a2ae96a?w=600&h=400&fit=crop' }
    ]
};
...
window.showTransportCategory = function(category) {
    ...
    items.forEach((item, index) => {
        const specs = item.year || '';
        const detail = item.engine || item.capacity || item.length || '';
        html += `
            <div class="house-card" style="animation-delay: ${index * 0.07}s;">
                <div class="house-image" style="background-image: url('${item.image}');">
                    <span class="house-status sale">В наличии</span>
                </div>
                <div class="house-info">
                    <div class="house-price">${item.price} <small>₽</small></div>
                    <div class="house-location"><i class="fas fa-info-circle"></i> ${specs} ${detail}</div>
                    <div class="seller-row">
                        <span class="seller-name"><i class="fas fa-tag"></i> ${item.name}</span>
                    </div>
                </div>
            </div>
        `;
